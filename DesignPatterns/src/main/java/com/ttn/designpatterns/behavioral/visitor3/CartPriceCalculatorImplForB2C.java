...
public class CartPriceCalculatorImplForB2C implements Visitor, ICartPriceCalculator {
    ...
    public CartPriceCalculatorImplForB2C(Map<Package, Double> packageCommissionMatrix, Map<Hotel, Double> hotelDiscountMatrix,
    ...
    public void visit(Hotel hotel) {
        //Note:- Discount is calculated after calculating tax..
        hotel.accept(this);
        hotelsCount++;
